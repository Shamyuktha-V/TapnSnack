...
int Cash_dispenser::checkBalance(char user_amount[13],Bill b)
{
    int i;
    int amount=0;
    string data;
...
int Cash_dispenser::get_balance()
{
    return balance;
}
...
void Bill::display_bill(Drinks dr[10],Chocolates ch[10],Chips cp[10])
{
    int i;
    cout<<"------------------------------------------------------\n";
